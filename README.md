# Disruptive Final: Wellness Blockchain Platform
...
Disruptive Final is a next-generation blockchain wellness platform that empowers users to track and improve three critical health dimensions:
- Sleep quality
- Hydration levels
...
The Disruptive Final platform is engineered around a robust smart contract that securely manages user wellness data, personal objectives, and motivational achievements.
